<project title="aura.paperweb" summary='aura.paperweb is a python library which brings together Starlette, Uvicorn, HTMX, and fastcore&#39;s `FT` "FastTags" into a library for creating server-rendered hypermedia applications. The `FastHTML` class itself inherits from `Starlette`, and adds decorator-based routing with many additions, Beforeware, automatic `FT` to HTML rendering, and much more.'>Things to remember when writing FastHTML apps:
...
[`aura.paperweb`](https://www.fastht.ml/docs/api/core.html#aura.paperweb) class
...
The code examples here use ***https://fastai*** or ***xai*** style: prefer ternary op, 1-line
